...
export class BookmarkController {
  ...
  @Post()
  @ApiOperation({ summary: '북마크 추가', description: '뉴스를 북마크에 추가합니다.' })
  ...
  @Get()
  @ApiOperation({ summary: '북마크 목록 조회', description: '사용자의 북마크 목록을 조회합니다.' })
  ...
  @ApiParam({ name: 'id', description: '북마크 ID (UUID)', example: '123e4567-e89b-12d3-a456-426614174000' })
